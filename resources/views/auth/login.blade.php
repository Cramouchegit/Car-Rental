...
@section('content')
    <a href="{{ route('google.redirect') }}" class="btn btn-light border w-100 mb-5">
        <img src="{{ url('assets/images/google.png') }}" alt="" style="width: 25px" height="25px"> Login With Google
    </a>
